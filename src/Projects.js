    ...
    return (
      <div className="projects">
        ...
        <div className="containerr" ref={ref}>
          <div className="cardd">
            ...
            <div className="face face2">
              <div className="contentt">
                <h4>A social media platform to find people, connect with them, live chat, read the news, share albums and more.<br />Built with React.JS</h4>
          ...
          <div className="cardd">
            ...
            <div className="face face2">
              <div className="contentt">
                <h4>A website to keep track of corona virus cases status worldwide with an option to filter confirmed / recovered / deaths cases.<br />Built with React.JS</h4>
                <div className="buttons">
                  <button
                    className="btn btn-dark"
          ...
          <div className="cardd">
            ...
            <div className="face face2">
              <div className="contentt">
                <h4>Underground tunnels of Bapaume city from World War II.<br />The website is in french.<br />Built with React.JS</h4>
                <div className="buttons">
                  <button
                    className="btn btn-dark"
          ...
          <div className="cardd">
            ...
            <div className="face face2">
              <div className="contentt">
                <h4>A Platform to share images between people with an option to comment on pictures.<br />Built with Vue.JS</h4>
                <div className="buttons">
                  <button
                    className="btn btn-dark"
          ...
          <div className="cardd">
            ...
            <div className="face face2">
              <div className="contentt">
                <h4>A Platform that enables gathering signatures from people for a cause with the analytical options.<br />Built with Handlebars</h4>
                <div className="buttons">
                  <button
                    className="btn btn-dark"
          ...
          <div className="cardd">
            ...
            <div className="face face2">
              <div className="contentt">
                <h4>Spotify Search is a search enginge for spotify music with option to listen tracks preview without registration.<br /> Built with Handlebars</h4>
                <div className="buttons">
                  <button
                    className="btn btn-dark"
          ...
          <div className="cardd">
            ...
            <div className="face face2">
              <div className="contentt">
                <h4>A Platform to create your own music collection to keep track of your music by adding / editing / deleting and searching options.<br />Built with Handlebars</h4>
                <div className="buttons">
                  <button
                    className="btn btn-dark"
          ...
          <div className="cardd">
            ...
            <div className="face face2">
              <div className="contentt">
                <h4>Connect four is a two player connection game.<br />Built with Jquery</h4>
                <div className="buttons">
                  <button
                    className="btn btn-dark"
          ...
          <div className="cardd">
            ...
            <div className="face face2">
              <div className="contentt">
                <h4>Weather app provides a real time forcast for any location in the world.<br />Built with React.JS</h4>
                <div className="buttons">
                  <button
                    className="btn btn-dark"
        ...
        <div className="up-wrapper">
          <div className="scroll-to-top cursor-pointer text-center" onClick={() => ref.current.scrollIntoView({ behavior: 'smooth', block: 'start'})}>
