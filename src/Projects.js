            ...
            <div className="content_inner">
              ...
              Built with React.JS</h4>
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        href="http://adirsocialnetwork.herokuapp.com"
                                    >Visit</a>
                                    <br />
                                </div>
                            </div>
              ...
              Built with React.JS</h4>
                                    <a
                                        ...
                                        rel="noopener noreferrer"
                                        target="_blank"
                                        href="https://covid-19status.herokuapp.com"
                                    >Visit</a>
                                </div>
                            </div>
                        </div>
          ...
          Built with Vue.JS</h4>
              ...
              Built with Handlebars</h4>
                                    ...
                                    <a
                                        ...
                                        rel="noopener noreferrer"
                                        target="_blank"
                                        href="http://adir-petition.herokuapp.com"
                                    >Visit</a>
                                </div>
                            </div>
                        </div>
                        ...
                        Built with Handlebars</h4>
                                    <a
                                        ...
                                        rel="noopener noreferrer"
                                        target="_blank"
                                        href="https://spotify4search.herokuapp.com"
                                    >Visit</a>
                                </div>
                            </div>
                        </div>
                        ...
                        Built with Handlebars</h4>
                                    <a
                                        ...
                                        rel="noopener noreferrer"
                                        target="_blank"
                                        href="https://vinyls-collection.herokuapp.com"
                                    >Visit</a>
                                </div>
                            </div>
                        </div>
                        ...
                        Built with Jquery</h4>
                                    ...
                                    <a
                                        ...
                                        rel="noopener noreferrer"
                                        target="_blank"
                                        href="https://adir-connect-four.s3.amazonaws.com/connect-four/index.html"
                                    >Visit</a>
                                </div>
                            </div>
                        </div>
                        <div className="containerr">
                            ...
                            Built with React.JS</h4>
                                    ...
                                    <a
                                        ...
                                        rel="noopener noreferrer"
                                        target="_blank"
                                        href="https://adir-weather.herokuapp.com"
                                    >Visit</a>
                                </div>
                            </div>
                        </div>
