...
const MoveStuffAround = () => (
    <div className="ticker-wrap">
        <div className="ticker">
            <div className="ticker__item"><img style={{ width: "50px" }} src="./pictures/logos/html-5.svg" alt="" /></div>
            <div className="ticker__item"><img style={{ width: "50px" }} src="./pictures/logos/css.svg" alt="" /></div>
            <div className="ticker__item"><img style={{ width: "50px" }} src="./pictures/logos/javascript.svg" alt="" /></div>
            <div className="ticker__item"><img style={{ width: "50px" }} src="./pictures/logos/node.png" alt="" /></div>
            <div className="ticker__item"><img style={{ width: "50px" }} src="./pictures/logos/jquery.svg" alt="" /></div>
            <div className="ticker__item react-logo"><img style={{ width: "50px" }} src="./pictures/logos/icons8-react.svg" alt="" /></div>
            <div className="ticker__item"><img style={{ width: "50px" }} src="./pictures/logos/vue-js.svg" alt="" /></div>
            ...
            <div className="ticker__item"><img style={{ width: "50px" }} src="./pictures/logos/hotjar.svg" alt="" /></div>
            ...
            <div className="ticker__item"><img style={{ width: "50px" }} src="./pictures/logos/jest.svg" alt="" /></div>
